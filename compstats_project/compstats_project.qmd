...
::::{.columns}
:::{.column width="50%" .fragment}
![](figures/algo1.png){width="100%"}
:::
:::{.column width="50%"}

[An $L$ that is **too small** will yield to successive steps being very close to each other. The sampler then exhibits a form of **random walk behavior**.]{.fragment}

:vspace1

[An $L$ that is **too large** gives rise to the risk of the trajectory looping back.]{.fragment}

:vspace1

[It is **difficult** to find out what the right $L$ in a given case is. What is usually done is to run the sampler preliminarily and check autocorrelation statistics.]{.fragment}
...
:::{.centering}
![](figures/three_peak_trace_1000.svg){width="120%" .fragment}
:::
