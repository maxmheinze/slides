...
* Pre-determined step-size and length of path (use of discretizer)
...
* the [**potential energy**]{.col2} $\boldsymbol{p}$ corresponds to the [**negative log of the probability density**]{.col2} for these variables.
...
Using **Hamiltonian dynamics** to sample from a distribution requires translating the density to a [**potential energy**]{.col2} function (using the concept of a canonical distribution from statistical mechanics) and introducing [**momentum**]{.col1} variables.
